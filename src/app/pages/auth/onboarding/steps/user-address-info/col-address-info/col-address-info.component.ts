...
@Component({
  selector: 'app-col-address-info',
  templateUrl: './col-address-info.component.html',
  styleUrls: ['./col-address-info.component.scss'],
})
export class COLAddressInfoComponent  implements OnInit {
  ...
  addressForm = new FormGroup({
    ...
    codigoPostal: new FormControl('', [Validators.pattern(/^[0-9]\d*$/), Validators.maxLength(6), Validators.minLength(3)]),
  ...
  ngOnInit() {
    ...
    console.log('user address info col')
  }
